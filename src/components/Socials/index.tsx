...
function Socials() {
  return (
    <div className={styles.container}>
      <a href="https://github.com/rafatrace" target="_blank" className={styles.link}>
      ...
      <a href="https://x.com/rafatrace" target="_blank" className={styles.link}>
        <svg
          width="24"
          height="24"
      ...
      <a href="https://www.linkedin.com/in/rafatrace/" target="_blank" className={styles.link}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
